...
func FindCommunityCompetitionsByOwner(owners types.List[types.PID], unk types.Bool) types.List[matchmake_extension_super_smash_bros_4_types.CommunityCompetition] {
	// TODO: implement
