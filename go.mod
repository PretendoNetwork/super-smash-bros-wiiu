module github.com/PretendoNetwork/super-smash-bros-wiiu
...
require (
	github.com/PretendoNetwork/nex-go/v2 v2.0.1 // indirect
	github.com/PretendoNetwork/nex-protocols-common-go/v2 v2.0.1 // indirect
	github.com/PretendoNetwork/nex-protocols-go/v2 v2.0.1 // indirect
